...
//
// Note: This function does not recalculate AllowanceTotal or ChargeTotal. If you have modified
// SpecifiedTradeAllowanceCharge, call UpdateAllowancesAndCharges() first.
