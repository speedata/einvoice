...
var (
	...
	// Custom rules not present in EN 16931 schematron but used in validation
	Check = Rule{
		Code:        "Check",
	...
	// Aliases for IGIC rules (Canary Islands)
	// Official schematron uses BR-AF-* but code uses BR-IG-* notation
	BRIG1  = BRAF1
	BRIG2  = BRAF2
	BRIG3  = BRAF3
	BRIG4  = BRAF4
	...
	// Aliases for IPSI rules (Ceuta/Melilla)
	// Official schematron uses BR-AG-* but code uses BR-IP-* notation
	BRIP1  = BRAG1
	BRIP2  = BRAG2
	BRIP3  = BRAG3
	BRIP4  = BRAG4
